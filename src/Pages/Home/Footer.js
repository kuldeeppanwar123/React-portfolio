  ...
  return (
    <footer className="footer--container">
      ...
      <div className="footer--content--container">
        <p className="footer--content made--by--kuldeep">Made by💜Kuldeep</p>
        <div className="footer--social--icon">
          <ul className="footer--contact--section">
            <li>
               <CiLocationOn className='footer--icon address--icon'/>{'\u00A0\u00A0'} <a className="address---link" href="https://maps.app.goo.gl/8fAWbdXv7gYYgmWF6" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",color:"inherit"}}> <strong>G.M. Ring raod, Indore(M.P.) 452001 </strong></a>
            </li>
            <li>
               <AiOutlineMail className='footer--icon'/>{'\u00A0\u00A0'} <a href="mailto:kuldeeppanwar460@gmail.com" target="_blank" rel="noopener noreferrer" className="email---link" style={{textDecoration:"none",color:"inherit"}}><strong>kuldeeppanwar460@gmail.com</strong></a>
            </li>
            <li>
               <BsPhone className='footer--icon'/>{'\u00A0\u00A0'} <a href="tel:7489912877" className="phone---link" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",color:"inherit"}}><strong>+91 7489912877</strong></a>
            </li>
          </ul>
        </div>
      </div>
